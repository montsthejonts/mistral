...
st.markdown("<h3 style color: white;'>Built by <a href='Saurav Mohanty'>From Saurav </a></h3>", unsafe_allow_html=True)
with st.expander("Expand Me"):
    st.markdown("""
    This application allows you to extract information from pdf/image based on Mistral OCR. Built by Saurav.
    """)
